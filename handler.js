...
global.dfail = (type, m, conn) => {
    const msg = {
        rowner: `🚩 Hola, este comando solo puede ser utilizado por *ALEIZN*.`,
        owner: `👤 Usuario, Este Comando Solo Puede Ser Utilizado Por *ALEIZN*.`,
        mods: `🤚🏻 Hola, este comando solo puede ser utilizado por *ALEIZN*.`,
